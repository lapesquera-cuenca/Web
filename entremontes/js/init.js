		...
		// Initialize header
			...
			// Homepage header
				if ($body.hasClass('homepage'))
				{
					...
					{
						$window.on('resize.helios', function() {
							window.setTimeout(function() {
